...
# ems_solve informs terminal run
    ...
    Message
      ...
      docker run --rm --mount type=bind,src=C:/Users/PC/AppData/Local/R/cache/R/teems/solve/solve_info_terminal,dst=/opt/teems teems:latest /bin/bash -c "/opt/teems-solver/lib/mpi/bin/mpiexec -n 1 /opt/teems-solver/solver/hsl -cmdfile /opt/teems/GTAPv7.cmf -matsol 0  -nsubints 1 -solmed Johansen -laA 300 -laDi 500 -laD 200 -maxthreads 1 -nox 2>&1 | tee /opt/teems/out/solver_out_HHMM.txt"
